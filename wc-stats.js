const FRANCE = require("./France_1998.json")
const KOREA_JAPAN = require("./Korea-Japan_2002.json")
const GERMANY = require("./Germany_2006.json")
const SOUTH_AFRICA = require("./South_Africa_2010.json")
const BRAZIL = require("./Brazil_2014.json")
