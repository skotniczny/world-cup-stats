...
})({"e2lBH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _dataJson = require("../json/data.json");
...
const BarChartLabels = {
    ...
    afterDatasetsDraw: (chart)=>{
        ...
        chart.data.datasets.forEach((dataset, i)=>{
            ...
            if (!meta.hidden) meta.data.forEach((element, index)=>{
                // Draw the text in black, with the specified font
                ctx.fillStyle = "rgb(0, 0, 0)";
                const fontSize = 16;
                const fontStyle = "normal";
                const fontFamily = "Segoe UI, Helvetica Neue, Arial, sans-serif";
                ctx.font = (0, _helpers.fontString)(fontSize, fontStyle, fontFamily);
...
(0, _chartJs.Chart).register({
    BarController: (0, _chartJs.BarController),
    BarElement: (0, _chartJs.BarElement),
    CategoryScale: (0, _chartJs.CategoryScale),
    LinearScale: (0, _chartJs.LinearScale),
    Legend: (0, _chartJs.Legend),
    Tooltip: (0, _chartJs.Tooltip),
    BarChartLabels
});
(0, _chartJs.Chart).defaults.plugins.legend.display = false;
(0, _chartJs.Chart).defaults.maintainAspectRatio = true;
(0, _chartJs.Chart).defaults.layout.padding.top = 20;
(0, _chartJs.Chart).defaults.scale.ticks.beginAtZero = true;
(0, _chartJs.Chart).defaults.plugins.tooltip.callbacks.label = (tooltipItem)=>{
...
const quatarChart = new (0, _chartJs.Chart)(ctxQuatar, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).quatar.mostFrequentScores),
    options: {
        title: {
            display: true,
...
// eslint-disable-next-line no-unused-vars
const russiaChart = new (0, _chartJs.Chart)(ctxRussia, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).russia.mostFrequentScores),
    options: {
        title: {
            display: true,
            text: "Most Common Scores"
...
// eslint-disable-next-line no-unused-vars
const brazilChart = new (0, _chartJs.Chart)(ctxBrazil, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).brazil.mostFrequentScores),
    options: {
        title: {
            display: true,
            text: "Most Common Scores"
...
// eslint-disable-next-line no-unused-vars
const southAfricaChart = new (0, _chartJs.Chart)(ctxSouthAfrica, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).south_africa.mostFrequentScores),
    options: {
        title: {
            display: true,
            text: "Most Common Scores"
...
// eslint-disable-next-line no-unused-vars
const germanyChart = new (0, _chartJs.Chart)(ctxGermany, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).germany.mostFrequentScores),
    options: {
        title: {
            display: true,
            text: "Most Common Scores"
...
// eslint-disable-next-line no-unused-vars
const koreaJapanChart = new (0, _chartJs.Chart)(ctxKoreaJapan, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).korea_japan.mostFrequentScores),
    options: {
        title: {
            display: true,
            text: "Most Common Scores"
...
// eslint-disable-next-line no-unused-vars
const franceChart = new (0, _chartJs.Chart)(ctxFrance, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).france.mostFrequentScores),
    options: {
        title: {
            display: true,
            text: "Most Common Scores"
...
// eslint-disable-next-line no-unused-vars
const last6Chart = new (0, _chartJs.Chart)(ctxLast6, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).last_6_world_cups.mostFrequentScores),
    options: {
        title: {
            display: true,
            text: "Most Common Scores"
...
// eslint-disable-next-line no-unused-vars
const last6GroupChart = new (0, _chartJs.Chart)(ctxLast6Group, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).last_6_world_cups.mostFrequentScoresGroupStage),
    options: {
        title: {
            display: true,
...
// eslint-disable-next-line no-unused-vars
const last6PlayOffChart = new (0, _chartJs.Chart)(ctxLast6PlayOff, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).last_6_world_cups.mostFrequentScoresPlayOffStage),
    options: {
        title: {
            display: true,
...
// eslint-disable-next-line no-unused-vars
const diffChart = new (0, _chartJs.Chart)(ctxDiff, {
    type: "bar",
    data: (0, _utilsJs.makeData)((0, _dataJsonDefault.default).last_6_world_cups.goalsDiff),
    options: {
        title: {
            display: true,
...
const scoresHeadings = [
    "Scoreline",
    "Number Of Games",
    "Percent"
];
(0, _utilsJs.makeTable)(document.querySelector("#scores-quatar"), scoresHeadings, (0, _dataJsonDefault.default).quatar.mostFrequentScores);
(0, _utilsJs.makeTable)(document.querySelector("#scores-quatar-group"), scoresHeadings, (0, _dataJsonDefault.default).quatar.mostFrequentScoresGroupStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-quatar-playoff"), scoresHeadings, (0, _dataJsonDefault.default).quatar.mostFrequentScoresPlayOffStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-russia"), scoresHeadings, (0, _dataJsonDefault.default).russia.mostFrequentScores);
(0, _utilsJs.makeTable)(document.querySelector("#scores-russia-group"), scoresHeadings, (0, _dataJsonDefault.default).russia.mostFrequentScoresGroupStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-russia-playoff"), scoresHeadings, (0, _dataJsonDefault.default).russia.mostFrequentScoresPlayOffStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-brazil"), scoresHeadings, (0, _dataJsonDefault.default).brazil.mostFrequentScores);
(0, _utilsJs.makeTable)(document.querySelector("#scores-brazil-group"), scoresHeadings, (0, _dataJsonDefault.default).brazil.mostFrequentScoresGroupStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-brazil-playoff"), scoresHeadings, (0, _dataJsonDefault.default).brazil.mostFrequentScoresPlayOffStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-south_africa"), scoresHeadings, (0, _dataJsonDefault.default).south_africa.mostFrequentScores);
(0, _utilsJs.makeTable)(document.querySelector("#scores-south_africa-group"), scoresHeadings, (0, _dataJsonDefault.default).south_africa.mostFrequentScoresGroupStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-south_africa-playoff"), scoresHeadings, (0, _dataJsonDefault.default).south_africa.mostFrequentScoresPlayOffStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-germany"), scoresHeadings, (0, _dataJsonDefault.default).germany.mostFrequentScores);
(0, _utilsJs.makeTable)(document.querySelector("#scores-germany-group"), scoresHeadings, (0, _dataJsonDefault.default).germany.mostFrequentScoresGroupStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-germany-playoff"), scoresHeadings, (0, _dataJsonDefault.default).germany.mostFrequentScoresPlayOffStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-korea_japan"), scoresHeadings, (0, _dataJsonDefault.default).korea_japan.mostFrequentScores);
(0, _utilsJs.makeTable)(document.querySelector("#scores-korea_japan-group"), scoresHeadings, (0, _dataJsonDefault.default).korea_japan.mostFrequentScoresGroupStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-korea_japan-playoff"), scoresHeadings, (0, _dataJsonDefault.default).korea_japan.mostFrequentScoresPlayOffStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-france"), scoresHeadings, (0, _dataJsonDefault.default).france.mostFrequentScores);
(0, _utilsJs.makeTable)(document.querySelector("#scores-france-group"), scoresHeadings, (0, _dataJsonDefault.default).france.mostFrequentScoresGroupStage);
(0, _utilsJs.makeTable)(document.querySelector("#scores-france-playoff"), scoresHeadings, (0, _dataJsonDefault.default).france.mostFrequentScoresPlayOffStage);
const diffHeadings = [
    "Goals Difference",
    "Number",
    "Percent"
];
(0, _utilsJs.makeTable)(document.querySelector("#diff-quatar"), diffHeadings, (0, _dataJsonDefault.default).quatar.goalsDiff);
(0, _utilsJs.makeTable)(document.querySelector("#diff-russia"), diffHeadings, (0, _dataJsonDefault.default).russia.goalsDiff);
(0, _utilsJs.makeTable)(document.querySelector("#diff-brazil"), diffHeadings, (0, _dataJsonDefault.default).brazil.goalsDiff);
(0, _utilsJs.makeTable)(document.querySelector("#diff-south_africa"), diffHeadings, (0, _dataJsonDefault.default).south_africa.goalsDiff);
(0, _utilsJs.makeTable)(document.querySelector("#diff-germany"), diffHeadings, (0, _dataJsonDefault.default).germany.goalsDiff);
(0, _utilsJs.makeTable)(document.querySelector("#diff-korea_japan"), diffHeadings, (0, _dataJsonDefault.default).korea_japan.goalsDiff);
(0, _utilsJs.makeTable)(document.querySelector("#diff-france"), diffHeadings, (0, _dataJsonDefault.default).france.goalsDiff);
const avgData = [
    [
        "Quatar 2022",
        (0, _dataJsonDefault.default).quatar.goalsScored,
        (0, _dataJsonDefault.default).quatar.goalsAvg
    ],
    [
        "Russia 2018",
        (0, _dataJsonDefault.default).russia.goalsScored,
        (0, _dataJsonDefault.default).russia.goalsAvg
    ],
    [
        "Brazil 2014",
        (0, _dataJsonDefault.default).brazil.goalsScored,
        (0, _dataJsonDefault.default).brazil.goalsAvg
    ],
    [
        "South Africa 2010",
        (0, _dataJsonDefault.default).south_africa.goalsScored,
        (0, _dataJsonDefault.default).south_africa.goalsAvg
    ],
    [
        "Germany 2006",
        (0, _dataJsonDefault.default).germany.goalsScored,
        (0, _dataJsonDefault.default).germany.goalsAvg
    ],
    [
        "Korea/Japan 2002",
        (0, _dataJsonDefault.default).korea_japan.goalsScored,
        (0, _dataJsonDefault.default).korea_japan.goalsAvg
    ],
    [
        "France 1998",
        (0, _dataJsonDefault.default).france.goalsScored,
        (0, _dataJsonDefault.default).france.goalsAvg
    ],
    [
        "Last 7 World Cups",
        (0, _dataJsonDefault.default).last_6_world_cups.goalsScored,
        (0, _dataJsonDefault.default).last_6_world_cups.goalsAvg
    ]
];
(0, _utilsJs.makeTable)(document.querySelector("#scored-goals"), [
    "World Cup",
    "Goals Scored",
    "Goals Per Match"
], avgData);
const goalsByHeadings = [
    "Goals Scored",
    "Occurrences",
    "Percent"
];
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-quatar"), goalsByHeadings, (0, _dataJsonDefault.default).quatar.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-russia"), goalsByHeadings, (0, _dataJsonDefault.default).russia.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-brazil"), goalsByHeadings, (0, _dataJsonDefault.default).brazil.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-south_africa"), goalsByHeadings, (0, _dataJsonDefault.default).south_africa.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-germany"), goalsByHeadings, (0, _dataJsonDefault.default).germany.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-korea_japan"), goalsByHeadings, (0, _dataJsonDefault.default).korea_japan.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-france"), goalsByHeadings, (0, _dataJsonDefault.default).france.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-winner-last_6"), goalsByHeadings, (0, _dataJsonDefault.default).last_6_world_cups.goalsScoredByWinners);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-quatar"), goalsByHeadings, (0, _dataJsonDefault.default).quatar.goalsScoredByLosers);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-russia"), goalsByHeadings, (0, _dataJsonDefault.default).russia.goalsScoredByLosers);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-brazil"), goalsByHeadings, (0, _dataJsonDefault.default).brazil.goalsScoredByLosers);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-south_africa"), goalsByHeadings, (0, _dataJsonDefault.default).south_africa.goalsScoredByLosers);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-germany"), goalsByHeadings, (0, _dataJsonDefault.default).germany.goalsScoredByLosers);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-korea_japan"), goalsByHeadings, (0, _dataJsonDefault.default).korea_japan.goalsScoredByLosers);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-france"), goalsByHeadings, (0, _dataJsonDefault.default).france.goalsScoredByLosers);
(0, _utilsJs.makeTable)(document.querySelector("#goals-by-losers-last_6"), goalsByHeadings, (0, _dataJsonDefault.default).last_6_world_cups.goalsScoredByLosers);
(0, _utilsJs.makeTabs)(document.querySelectorAll(".tab-panel"));

},{"../json/data.json":"fAgnv","chart.js":"ipU8D","chart.js/helpers":"dxsY3","./utils.js":"jOYIl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fAgnv":[function(require,module,exports) {
module.exports = JSON.parse('{"quatar":{"mostFrequentScores":[["2-0",11,19],["2-1",9,15.5],["1-0",9,15.5],["0-0",7,12.1],["1-1",5,8.6],["4-1",3,5.2],["3-2",3,5.2],["3-1",3,5.2],["3-0",2,3.4],["6-2",1,1.7],["7-0",1,1.7],["3-3",1,1.7],["4-2",1,1.7],["6-1",1,1.7],["2-2",1,1.7]],"mostFrequentScoresGroupStage":[["2-0",11,22.9],["1-0",9,18.8],["2-1",8,16.7],["0-0",6,12.5],["1-1",3,6.3],["3-2",3,6.3],["4-1",2,4.2],["6-2",1,2.1],["7-0",1,2.1],["3-1",1,2.1],["3-3",1,2.1],["3-0",1,2.1],["4-2",1,2.1]],"mostFrequentScoresPlayOffStage":[["3-1",2,20],["1-1",2,20],["2-1",1,10],["3-0",1,10],["4-1",1,10],["0-0",1,10],["6-1",1,10],["2-2",1,10]],"goalsDiff":[["0",14,24.1],["1",21,36.2],["2",15,25.9],["3",5,8.6],["4",1,1.7],["5",1,1.7],["7",1,1.7]],"goalsScored":154,"goalsAvg":2.66,"goalsScoredByWinners":[["2",20,45.5],["1",9,20.5],["3",8,18.2],["4",4,9.1],["6",2,4.5],["7",1,2.3]],"goalsScoredByLosers":[["0",23,52.3],["1",16,36.4],["2",5,11.4]]},"russia":{"mostFrequentScores":[["1-0",15,23.4],["2-1",14,21.9],["2-0",10,15.6],["1-1",7,10.9],["3-0",5,7.8],["2-2",4,6.3],["5-0",1,1.6],["3-3",1,1.6],["3-1",1,1.6],["5-2",1,1.6],["6-1",1,1.6],["0-0",1,1.6],["4-3",1,1.6],["3-2",1,1.6],["4-2",1,1.6]],"mostFrequentScoresGroupStage":[["1-0",13,27.1],["2-1",11,22.9],["2-0",6,12.5],["3-0",5,10.4],["1-1",4,8.3],["2-2",3,6.3],["5-0",1,2.1],["3-3",1,2.1],["3-1",1,2.1],["5-2",1,2.1],["6-1",1,2.1],["0-0",1,2.1]],"mostFrequentScoresPlayOffStage":[["2-0",4,25],["2-1",3,18.8],["1-1",3,18.8],["1-0",2,12.5],["
FrequentScoresPlayOffStage":[["2-1",5,31.3],["1-0",3,18.8],["4-1",2,12.5],["3-0",2,12.5],["2-2",1,6.3],["0-0",1,6.3],["3-2",1,6.3],["1-1",1,6.3]],"goalsDiff":[["0",19,29.7],["1",26,40.6],["2",7,10.9],["3",8,12.5],["4",1,1.6],["5",3,4.7]],"goalsScored":171,"goalsAvg":2.67,"goalsScoredByWinners":[["2",16,35.6],["1",12,26.7],["3",11,24.4],["4",3,6.7],["5",2,4.4],["6",1,2.2]],"goalsScoredByLosers":[["0",25,55.6],["1",18,40],["2",2,4.4]]},"last_6_world_cups":{"mostFrequentScores":[["1-0",93,21],["2-1",76,17.2],["2-0",58,13.1],["1-1",46,10.4],["0-0",36,8.1],["3-0",29,6.6],["3-1",24,5.4],["2-2",21,4.8],["3-2",16,3.6],["4-1",10,2.3],["4-0",9,2],["4-2",4,0.9],["5-0",3,0.7],["6-1",3,0.7],["3-3",3,0.7],["5-2",3,0.7],["7-0",2,0.5],["8-0",1,0.2],["6-0",1,0.2],["5-1",1,0.2],["7-1",1,0.2],["4-3",1,0.2],["6-2",1,0.2]],"mostFrequentScoresGroupStage":[["1-0",69,20.5],["2-1",55,16.4],["2-0",47,14],["1-1",34,10.1],["0-0",28,8.3],["3-0",21,6.3],["3-1",19,5.7],["2-2",18,5.4],["3-2",11,3.3],["4-0",8,2.4],["4-1",6,1.8],["5-0",3,0.9],["3-3",3,0.9],["5-2",3,0.9],["4-2",3,0.9],["6-1",2,0.6],["7-0",2,0.6],["8-0",1,0.3],["6-0",1,0.3],["5-1",1,0.3],["6-2",1,0.3]],"mostFrequentScoresPlayOffStage":[["1-0",24,22.6],["2-1",21,19.8],["1-1",12,11.3],["2-0",11,10.4],["0-0",8,7.5],["3-0",8,7.5],["3-2",5,4.7],["3-1",5,4.7],["4-1",4,3.8],["2-2",3,2.8],["4-0",1,0.9],["7-1",1,0.9],["4-3",1,0.9],["4-2",1,0.9],["6-1",1,0.9]],"goalsDiff":[["0",106,24],["1",186,42.1],["2",86,19.5],["3",42,9.5],["4",11,2.5],["5",6,1.4],["6",2,0.5],["7",2,0.5],["8",1,0.2]],"goalsScored":1118,"goalsAvg":2.53,"goalsScoredByWinners":[["2",134,39.9],["1",93,27.7],["3",69,20.5],["4",24,7.1],["5",7,2.1],["6",5,1.5],["7",3,0.9],["8",1,0.3]],"goalsScoredByLosers":[["0",196,58.3],["1",115,34.2],["2",24,7.1],["3",1,0.3]]}}');
...
},{"./chunks/helpers.segment.js":"7oQuk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jOYIl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeData", ()=>makeData);
parcelHelpers.export(exports, "makeTable", ()=>makeTable);
parcelHelpers.export(exports, "makeTabs", ()=>makeTabs);
...
function makeTabs(nodeList) {
    ...
    function selectTab(selectedTab, tabs) {
        for (const tab of tabs){
            ...
            if (selected) tab.button.classList.add("active");
            else tab.button.classList.remove("active");
        }
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["e2lBH"], "e2lBH", "parcelRequire93df")

//# sourceMappingURL=index.1c711d5f.js.map
